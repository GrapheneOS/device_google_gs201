...
# TODO: These will probably need to be updated to 2025-03-01.
PRODUCT_COPY_FILES += \
...
# USB HAL
PRODUCT_COPY_FILES += \
    device/google/gs201/usb/usb/android.hardware.usb-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.usb-service.rc
...
# TODO: Need to update these files from device.
PRODUCT_COPY_FILES += \
